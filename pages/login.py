...
with tab_login:
    ...
    if url:
        ...
        # Render a premium native HTML button pointing directly to the Google authorize URL in target="_top"
        ...
        <div style="margin-top: 0.5rem; text-align: center;">
            ...
            " onmouseover="this.style.backgroundColor='rgba(255, 255, 255, 0.08)'; this.style.borderColor='rgba(255, 255, 255, 0.15)';" onmouseout="this.style.backgroundColor='rgba(255, 255, 255, 0.03)'; this.style.borderColor='rgba(255, 255, 255, 0.08)';">
                <span style="font-size: 1.1rem; margin-right: 0.6rem; display: inline-block; vertical-align: middle;">
        ...
        """
        st.markdown(clean_html(google_button_html), unsafe_allow_html=True)
    else:
